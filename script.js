...
(function(){
  ...
  /* ---------- scroll reveal (shared observer — also used for elements added later, like real portfolio photos) ---------- */
  var revealSupported = !reducedMotion && ('IntersectionObserver' in window);
  var revealIO = revealSupported ? new IntersectionObserver(function(entries){
  ...
  function observeReveal(el){
    if(!revealSupported){ el.classList.add('in-view'); return; }
    revealIO.observe(el);
  }
